...
int BrachyUserScoreWriter::meshX=0;
int BrachyUserScoreWriter::meshY=0;
int BrachyUserScoreWriter::meshZ=0;
...
BrachyUserScoreWriter::BrachyUserScoreWriter(): G4VScoreWriter() //call superclass constructor!
{
